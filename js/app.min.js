...
document.addEventListener("DOMContentLoaded", () => {
  const getLanguageFromCookies = () => {
    ...
    return languageCookie ? languageCookie.split("=")[1] : "en";
  };

  const savedLanguage = getLanguageFromCookies(); // Գտնում ենք լեզուն cookies-ից
  language.value = savedLanguage; // Թարմացնում ենք ընտրիչի արժեքը
  languageMedia.value = savedLanguage;
...
const translations = {
  ...
  hy: {
    ...
    portfolio: "Պորտֆոլիո",
    contacts: "Կոնտակտներ",
    frontend: "Ֆրոնտենդ ծրագրավորող",
    title: "Բարև Ձեզ։ Ես Նարեկն եմ։ Ֆրոնտենդ ծրագրավորող եմ ավելի քան 4 տարվա փորձով։ Կատարելու եմ որակյալ աշխատանք՝ կարճ ժամանակում։",
    work: "Աշխատանքի արագություն",
    info: "Բոլոր պատվերները ժամանակին են առաքվում",
    quality: "Որակյալ աշխատանք",
    cross: "Բրաուզերային համատեղելիություն, վավեր, մաքուր կոդ",
    hours: "Աշխատաժամեր",
    adapt: "Հարմարվում եմ հաճախորդի գրաֆիկին՝ միշտ կապի մեջ լինելու համար",
    myname: "Մելիքսեթյան Նարեկ",
    vers: "Դիզայն (GULP)",
    opit: "Փորձ՝ ",
    hardWork: "Արագ աշխատանք",
    pravId: "Անվճար ուղղումներ",
    price1: "Գին՝ 7,70 $/ժամ",
    price2: "Գին՝ 15,40 $/ժամ",
    price3: "Գին՝ 5,13 $/ժամ",
    design: "Հարմարավետ դիզայն",
    code: "Որակյալ կոդ",
    veni: "Բարձր որակի դիզայն",
    zakId: "Պատվիրել",
    heading: "Բարի գալուստ իմ կայք",
    opitId1: "4 տարի",
    opitId2: "2 տարի",
    opitId3: "1 տարի",
  },
...
const languageMedia = document.querySelector(".activeLeng");
...
const heading = document.getElementById("heading");
const opitId1 = document.getElementById("opitId-1");
const opitId2 = document.getElementById("opitId-2");
const opitId3 = document.getElementById("opitId-3");

language.addEventListener("change", (ev) => {
  setLeng(ev.target.value);
});

languageMedia.addEventListener("change", (ev) => {
  setLeng(ev.target.value);
});
...
const setLeng = (leng) => {
  ...
  document.cookie = `language=${leng}; path=/; max-age=31536000`;
  if (leng == "en") {
    ...
    heading.textContent = translations.en.heading;
    opitId1.textContent = translations.en.opitId1;
    opitId2.textContent = translations.en.opitId2;
    opitId3.textContent = translations.en.opitId3;
  } else if (leng == "ru") {
    ...
    heading.textContent = translations.ru.heading;
    opitId1.textContent = translations.ru.opitId1;
    opitId2.textContent = translations.ru.opitId2;
    opitId3.textContent = translations.ru.opitId3;
  } else {
    home.textContent = translations.hy.home;
    advantages.textContent = translations.hy.advantages;
    skills.textContent = translations.hy.skills;
    services.textContent = translations.hy.services;
    portfolio.textContent = translations.hy.portfolio;
    contacts.textContent = translations.hy.contacts;
    frontend.textContent = translations.hy.frontend;
    titles.textContent = translations.hy.title;
    head.textContent = translations.hy.advantages;
    work.textContent = translations.hy.work;
    info.textContent = translations.hy.info;
    quality.textContent = translations.hy.quality;
    cross.textContent = translations.hy.cross;
    hours.textContent = translations.hy.hours;
    adapt.textContent = translations.hy.adapt;
    ski.textContent = translations.hy.skills;
    tit.textContent = translations.hy.services;
    port.textContent = translations.hy.portfolio;
    cont.textContent = translations.hy.contacts;
    myname.textContent = translations.hy.myname;
    homes.textContent = translations.hy.home;
    advantagess.textContent = translations.hy.advantages;
    skillss.textContent = translations.hy.skills;
    servicess.textContent = translations.hy.services;
    portfolios.textContent = translations.hy.portfolio;
    contactss.textContent = translations.hy.contacts;
    ma.textContent = translations.hy.home;
    ad.textContent = translations.hy.advantages;
    st.textContent = translations.hy.skills;
    se.textContent = translations.hy.services;
    po.textContent = translations.hy.portfolio;
    co.textContent = translations.hy.contacts;
    vers.textContent = translations.hy.vers;
    opitId.forEach((el) => {
      el.textContent = translations.hy.opit;
    });
    fastId.forEach((el) => {
      el.textContent = translations.hy.hardWork;
    });
    pravId.forEach((el) => {
      el.textContent = translations.hy.pravId;
    });
    price1.textContent = translations.hy.price1;
    price2.textContent = translations.hy.price2;
    price3.textContent = translations.hy.price3;
    design.textContent = translations.hy.design;
    code.textContent = translations.hy.code;
    veni.textContent = translations.hy.veni;
    zakId.forEach((el) => {
      el.textContent = translations.hy.zakId;
    });
    heading.textContent = translations.hy.heading;
    opitId1.textContent = translations.hy.opitId1;
    opitId2.textContent = translations.hy.opitId2;
    opitId3.textContent = translations.hy.opitId3;
  }
};
